...
//        
	...
	private func configureSession() {
		if setupResult != .success {
            print("JESS: Session is not successed")
			return
		}
		
		session.beginConfiguration()
		print("JESS: Session begins configing")
		/*
	...
	func toggleCaptureMode(_ captureMode: Int) {
		//captureModeControl.isEnabled = false
		
		if captureMode == CaptureMode.photo.rawValue {
			_recordButton.isEnabled = false
		...
		} else if captureMode == CaptureMode.movie.rawValue {
	...
	func toggleMovieRecording() {
		guard let movieFileOutput = self.movieFileOutput else {
            print("JESS: No movie file output")
			return
		}
